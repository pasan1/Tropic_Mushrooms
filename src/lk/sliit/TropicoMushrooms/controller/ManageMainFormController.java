...
public class ManageMainFormController {
    ...
    public void btnPurchaseOnAction(ActionEvent actionEvent) throws IOException {
        ManagePurchaseFormController.setUserId(userId);
        loadUI("manager/ManagePurchaseForm");
    ...
    public void btnUserOnAction(ActionEvent actionEvent) throws IOException {
        loadUI("manager/ManageUserForm");
        lblTitle.setText("Tropico Mushrooms's | Sale Management System | User Form");
    }
...
//                txtTime.setText((LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss"))));
    ...
    public static void setUserId(String userId) {
        ManageMainFormController.userId = userId;
    }

    public static void setUserName(String userName) {
        ManageMainFormController.userName = userName;
    }
}
